...
#기존에 github에 올라온 파일과 달라진점
    # 1. 과제에 올리신 내용 2개 (반복주문 가능, choice_main()구현)
    # 2. 비밀번호를 치면 키오스크 반복 중지 및 마감
    # 3. 주문을 시작할 때와 끝날 때 자신이 몇 번째 손님인지 기록
    # 4. side menu에 감튀가 없는게 아쉬워 추가
    # 5. 앞 손님이 주문을 끝내면 뒷 손님이 주문하기 전에 딜레이를 걸어 앞 손님이 영수증을 확인할 수 있게 만들었습니다.
